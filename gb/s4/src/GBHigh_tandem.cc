...
void GBHigh::tandem_swap(RTLVerilated* v) {
  v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_Loop_1_proc_U0->in_axi_stream_V_last_V_0_in_rdy = (uint8_t) GBHigh_arg_1_TREADY;
  v->v_top->hls_target->hls_target_Loop_1_proc_U0->arg_0_V_last_V_1_mVld = (uint8_t) GBHigh_arg_0_TVALID;
  v->v_top->hls_target->hls_target_Loop_1_proc_U0->arg_0_V_value_V_1_data_reg = (uint8_t) GBHigh_arg_0_TDATA;
  if ((GBHigh_ram_y >= 1) && (GBHigh_ram_x < 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->col_reg_349 = 488;
  if ((GBHigh_ram_y < 1) | (GBHigh_ram_x >= 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->col_reg_349 = (uint8_t)GBHigh_ram_x;
  if ((GBHigh_ram_y >= 1) && (GBHigh_ram_x < 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->row_1_reg_693 = (uint8_t)GBHigh_ram_y;
  if ((GBHigh_ram_y < 1) | (GBHigh_ram_x >= 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->row_1_reg_693 = (uint8_t)GBHigh_ram_y + 1;
  if ((GBHigh_ram_y >= 1) && (GBHigh_ram_x < 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->write_idx_1_1_reg_338 = (uint8_t)GBHigh_ram_w + 1;
  if ((GBHigh_ram_y < 1) | (GBHigh_ram_x >= 3))
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->write_idx_1_1_reg_338 = (uint8_t) GBHigh_ram_w;
  for (int i = 8; i > -1; i--) {
    int idx = i / 4;
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil0 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_0_value_V_fu_100[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil1 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_1_value_V_fu_104[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil2 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_2_value_V_fu_108[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil3 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_3_value_V_fu_112[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil4 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_4_value_V_fu_116[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil5 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_5_value_V_fu_120[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil6 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_6_value_V_fu_124[idx] |= (i_tmp << (jdx*8));
  }
  ...
  for (int i = 8; i > -1; i--) {
    ...
    int jdx = i % 4;
    int ila_shift = (8 - i) * 8;
    uint32_t i_tmp = ((uint32_t) ((GBHigh_stencil7 >> (ila_shift)) & (0xff)));
    v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_shift_proc_U0->buffer_7_value_V_fu_96[idx] |= (i_tmp << (jdx*8));
  }
