...
template<typename DTYPE, int AC_WMODE, int AC_NCOL, int AC_NROW>
    ...
    // Add an extra element to the linebuffer array if your row size is odd and if you're using singleport memories.
    enum { AC_NCOL2 = (AC_NCOL/((AC_WMODE&AC_SINGLEPORT) ? 2:1)) + int(AC_NCOL%2 != 0 && (AC_WMODE&AC_SINGLEPORT))};
