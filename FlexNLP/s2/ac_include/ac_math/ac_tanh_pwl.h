...
namespace ac_math
{
  ...
  )
  {
    ...
    static const ac_fixed<n_frac_bits - 1, -1, false> m_lut[n_segments_lut] = {.2451171875, .21875, .1728515625, .1259765625, .0859375, .0556640625, .0361328125, .0224609375, .013671875, .0087890625, .0048828125, .0029296875};
    static const ac_fixed<n_frac_bits, 0, false> c_lut[n_segments_lut] = {.0009765625, .24609375, .46484375, .6376953125, .7646484375, .8505859375, .90625, .9423828125, .96484375, .978515625, .9873046875, .9921875};
    // Domain of PWL
