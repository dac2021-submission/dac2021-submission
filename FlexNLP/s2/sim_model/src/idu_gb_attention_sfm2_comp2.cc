#include <flex.h>
bool flex::decode_GB_ATTENTION_CHILD_gb_attention_sfm2_comp2() {
sc_biguint<1> local_var_1 = 1;
bool local_var_2 = (flex_gb_attention_child_valid_flag == local_var_1);
sc_biguint<5> local_var_4 = 13;
bool local_var_5 = (flex_gb_attention_child_state == local_var_4);
bool local_var_6 = (local_var_2 & local_var_5);
auto& univ_var_608 = local_var_6;
return univ_var_608;
}
void flex::update_GB_ATTENTION_CHILD_gb_attention_sfm2_comp2() {
...
auto local_var_12 = GBAttentionSub(GB_ATTENTION_CHILD_gb_attention_exp_vector_2, GB_ATTENTION_CHILD_gb_attention_max_value);
...
auto local_var_19 = GBAttentionSub(GB_ATTENTION_CHILD_gb_attention_exp_vector_3, GB_ATTENTION_CHILD_gb_attention_max_value);
...
auto local_var_29 = GBAttentionSub(GB_ATTENTION_CHILD_gb_attention_exp_vector_1, GB_ATTENTION_CHILD_gb_attention_max_value);
...
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_10 = local_var_17_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_11 = local_var_22_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_8 = local_var_27_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_9 = local_var_32_nxt_holder;
}
