#include <flex.h>
bool flex::decode_PE1_CORE_CHILD_PE1_core_is_start() {
...
auto& univ_var_65 = local_var_14;
return univ_var_65;
}
void flex::update_PE1_CORE_CHILD_PE1_core_is_start() {
...
flex_pe1_act_reg_port_valid = local_var_0_nxt_holder;
PE1_CORE_CHILD_pe1_core_is_start = local_var_1_nxt_holder;
flex_pe1_core_state = local_var_2_nxt_holder;
