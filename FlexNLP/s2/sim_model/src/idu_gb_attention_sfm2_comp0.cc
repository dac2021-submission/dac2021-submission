#include <flex.h>
bool flex::decode_GB_ATTENTION_CHILD_gb_attention_sfm2_comp0() {
sc_biguint<1> local_var_1 = 1;
bool local_var_2 = (flex_gb_attention_child_valid_flag == local_var_1);
sc_biguint<5> local_var_4 = 11;
bool local_var_5 = (flex_gb_attention_child_state == local_var_4);
bool local_var_6 = (local_var_2 & local_var_5);
auto& univ_var_606 = local_var_6;
return univ_var_606;
}
void flex::update_GB_ATTENTION_CHILD_gb_attention_sfm2_comp0() {
...
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_0 = local_var_17_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_1 = local_var_22_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_2 = local_var_27_nxt_holder;
GB_ATTENTION_CHILD_gb_attention_softmax_result_vector_3 = local_var_32_nxt_holder;
}
