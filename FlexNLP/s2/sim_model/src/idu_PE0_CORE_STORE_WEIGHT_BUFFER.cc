...
sc_biguint<32> local_var_11 = 878706672;
...
auto& univ_var_872 = local_var_16;
return univ_var_872;
}
void flex::update_flex_PE0_CORE_STORE_WEIGHT_BUFFER() {
std::map<sc_biguint<32>, sc_biguint<8>> local_var_0;
store_873(local_var_0);
for (auto& it : local_var_0) {
  flex_pe0_core_weight_buffer[it.first] = it.second;
}
}
