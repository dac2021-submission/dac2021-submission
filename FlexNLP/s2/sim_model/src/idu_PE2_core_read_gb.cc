#include <flex.h>
bool flex::decode_PE2_CORE_CHILD_PE2_core_read_gb() {
sc_biguint<1> local_var_1 = 1;
bool local_var_2 = (flex_pe2_rnn_layer_sizing_is_valid == local_var_1);
sc_biguint<1> local_var_4 = 0;
bool local_var_5 = (PE2_CORE_CHILD_pe2_core_is_start == local_var_4);
...
bool local_var_17 = (flex_pe2_core_state == local_var_16);
bool local_var_18 = (local_var_14 & local_var_17);
auto& univ_var_99 = local_var_18;
return univ_var_99;
}
void flex::update_PE2_CORE_CHILD_PE2_core_read_gb() {
