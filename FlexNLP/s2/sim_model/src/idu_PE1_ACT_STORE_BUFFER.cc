...
sc_biguint<32> local_var_11 = 898630128;
...
auto& univ_var_882 = local_var_16;
return univ_var_882;
}
void flex::update_flex_PE1_ACT_STORE_BUFFER() {
std::map<sc_biguint<32>, sc_biguint<8>> local_var_0;
store_883(local_var_0);
