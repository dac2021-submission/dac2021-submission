#include <flex.h>
bool flex::decode_PE0_CORE_CHILD_PE0_core_read_gb() {
...
bool local_var_17 = (flex_pe0_core_state == local_var_16);
bool local_var_18 = (local_var_14 & local_var_17);
auto& univ_var_23 = local_var_18;
return univ_var_23;
}
void flex::update_PE0_CORE_CHILD_PE0_core_read_gb() {
