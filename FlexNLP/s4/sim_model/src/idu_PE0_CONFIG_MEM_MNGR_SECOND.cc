...
univ_var_812 = (sc_biguint<8>(flex_data_in_9), sc_biguint<8>(flex_data_in_8));
auto univ_var_812_nxt_holder = univ_var_812;
univ_var_813 = (sc_biguint<8>(flex_data_in_11), sc_biguint<8>(flex_data_in_10));
auto univ_var_813_nxt_holder = univ_var_813;
univ_var_814 = (sc_biguint<8>(flex_data_in_7), sc_biguint<8>(flex_data_in_6));
auto univ_var_814_nxt_holder = univ_var_814;
univ_var_815 = (sc_biguint<8>(flex_data_in_5), sc_biguint<8>(flex_data_in_4));
auto local_var_18 = univ_var_815.range(7, 0);
...
flex_pe0_mem_mngr_second_base_bias = univ_var_812_nxt_holder;
flex_pe0_mem_mngr_second_base_input = univ_var_813_nxt_holder;
flex_pe0_mem_mngr_second_base_weight = univ_var_814_nxt_holder;
