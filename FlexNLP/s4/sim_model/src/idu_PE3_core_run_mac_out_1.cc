#include <flex.h>
bool flex::decode_PE3_CORE_RUN_MAC_CHILD_PE3_core_run_mac_out_1() {
...
auto& univ_var_122 = local_var_13;
return univ_var_122;
}
void flex::update_PE3_CORE_RUN_MAC_CHILD_PE3_core_run_mac_out_1() {
auto local_var_2 = AccumAdd2(PE3_CORE_CHILD_PE3_core_accum_vector_1, PE3_CORE_RUN_MAC_CHILD_pe3_core_run_mac_child_result_temp);
...
PE3_CORE_CHILD_PE3_core_accum_vector_1 = local_var_2_nxt_holder;
