...
sc_biguint<32> local_var_11 = 878710768;
...
auto& univ_var_874 = local_var_16;
return univ_var_874;
}
void flex::update_flex_PE0_CORE_STORE_INPUT_BUFFER() {
std::map<sc_biguint<32>, sc_biguint<8>> local_var_0;
store_875(local_var_0);
for (auto& it : local_var_0) {
  flex_pe0_core_input_buffer[it.first] = it.second;
}
}
