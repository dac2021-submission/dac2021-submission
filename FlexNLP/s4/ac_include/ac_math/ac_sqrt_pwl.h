...
namespace ac_math
{
  ...
  void ac_sqrt_pwl (const ac_fixed <W, I, false, Q, O> input, ac_fixed <outW, outI, false, outQ, outO> &output)
  {
    ...
    static const ac_fixed <n_frac_bits - 1, 0, false> m_lut[n_segments_lut] = {.08349609375, .0751953125, .0693359375, .064453125};
    static const ac_fixed <n_frac_bits, 0, false> c_lut[n_segments_lut] = {.707763671875, .791259765625, .866455078125, .935791015625};
    ...
    ac_fixed <sc_input_frac_bits + n_frac_bits, 1, false, pwlQ> normalized_output = m_lut[index]*input_sc_frac + c_lut[index];
    ...
    std::cout << "normalized_exp_temp1 = " << normalized_exp_temp1 << std::endl;
