...
sc_biguint<32> local_var_11 = 895483888;
...
auto& univ_var_878 = local_var_16;
return univ_var_878;
}
void flex::update_flex_PE1_CORE_STORE_WEIGHT_BUFFER() {
std::map<sc_biguint<32>, sc_biguint<8>> local_var_0;
store_879(local_var_0);
for (auto& it : local_var_0) {
  flex_pe1_core_weight_buffer[it.first] = it.second;
}
}
