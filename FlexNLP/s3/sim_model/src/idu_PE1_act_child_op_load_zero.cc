#include <flex.h>
bool flex::decode_PE1_ACT_CHILD_PE1_act_child_op_load_zero() {
...
auto& univ_var_250 = local_var_14;
return univ_var_250;
}
void flex::update_PE1_ACT_CHILD_PE1_act_child_op_load_zero() {
...
PE1_ACT_CHILD_PE1_act_reg_temp_0 = local_var_1_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_1 = local_var_3_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_10 = local_var_5_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_11 = local_var_7_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_12 = local_var_9_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_13 = local_var_11_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_14 = local_var_13_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_15 = local_var_15_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_2 = local_var_17_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_3 = local_var_19_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_4 = local_var_21_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_5 = local_var_23_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_6 = local_var_25_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_7 = local_var_27_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_8 = local_var_29_nxt_holder;
PE1_ACT_CHILD_PE1_act_reg_temp_9 = local_var_31_nxt_holder;
PE1_ACT_CHILD_pe1_act_state = local_var_32_nxt_holder;
}
