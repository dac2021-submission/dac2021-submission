...
namespace eval CatapultC_Extensions {
   ...
   proc altera_simulation_libs { tech lang simtool stage } {
      ...
      # into the library "lpm". In the QuestaSIM-Altera tree, the logical library name "lp" is
      ...
      if { ($baselibpath == "") && ![info exists env(QUARTUS_LIB)] } {
         ...
         puts "Error: Check your MODEL_TECH environment variable and QuestaSIM-Altera installation."
      }
      if { ($baselibpath == "") && [info exists env(QUARTUS_LIB)] } {
         # DCS groups installation is weird
