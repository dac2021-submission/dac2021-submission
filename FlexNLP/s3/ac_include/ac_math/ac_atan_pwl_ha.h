...
namespace ac_math
{
  ...
  )
  {
    ...
    static const ac_fixed<-4 + n_frac_bits, -4, false> m_lut[n_segments_lut] = {.0312347412109375, .03118896484375, .03106689453125, .0308837890625, .0306396484375, .0303497314453125, .0300140380859375, .0296173095703125, .0291900634765625, .028717041015625, .0282135009765625, .027679443359375, .0271148681640625, .026519775390625, .0259246826171875, .0253143310546875, .024688720703125, .0240631103515625, .0234222412109375, .0227813720703125, .02215576171875, .0215301513671875, .020904541015625, .020294189453125, .0196990966796875, .0191192626953125, .0185394287109375, .017974853515625, .017425537109375, .0168914794921875, .0163726806640625, .0158233642578125};
    static const ac_fixed<1 + n_frac_bits, 1, false> c_lut[n_segments_lut] = {0, .0312347412109375, .0624237060546875, .0934906005859375, .1243743896484375, .1550140380859375, .18536376953125, .2153778076171875, .2450103759765625, .274200439453125, .30291748046875, .3311309814453125, .3588104248046875, .38592529296875, .412445068359375, .4383697509765625, .46368408203125, .488372802734375, .5124359130859375, .535858154296875, .5586395263671875, .5807952880859375, .602325439453125, .6232452392578125, .6435394287109375, .663238525390625, .6823577880859375, .700897216796875, .7188720703125, .736297607421875, .7531890869140625, .769561767578125};
    static const ac_fixed<1 + n_frac_bits, 1, false> x_min_lut = .0;
    static const ac_fixed<1 + n_frac_bits, 1, false> x_max_lut = 1.0;
    static const ac_fixed<6 + n_frac_bits, 6, false> sc_constant_lut = 32.0;
...
//-------------------------------------------------------------------------
  ...
  )
  {
    ...
    const int recipW = AC_MAX(1, AC_MIN(28, W - 4)) + 28 + 2;
