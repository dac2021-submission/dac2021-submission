...
void adpfloat_mul_template(const AdpfloatType<W,E> in_a, const AdpfloatType<W,E> in_b, NVINTW(F)& out) {
...
void adpfloat_add_template(const AdpfloatType<W,E> in_a, const AdpfloatType<W,E> in_b, AdpfloatType<W,E>& out) {
...
template <unsigned int W, unsigned int E> 
void adpfloat_max_template(const AdpfloatType<W,E>& in_a, const AdpfloatType<W,E>& in_b, AdpfloatType<W,E>& out) {
  static const unsigned int M = W-E-1;
  //cout << "ina, inb: " << in_a << ", " << in_b << endl;  
...
template <unsigned int W, unsigned int E> 
void adpfloat_mean_template(const AdpfloatType<W,E>& in_a, const AdpfloatType<W,E>& in_b, AdpfloatType<W,E>& out) {
  static const unsigned int M = W-E-1;
  //cout << "ina, inb: " << in_a << ", " << in_b << endl;  
...
inline void adpfloat_add(const AdpfloatType<spec::kAdpfloatWordWidth,spec::kAdpfloatExpWidth> in_a, 
  ...
  adpfloat_add_template<spec::kAdpfloatWordWidth, 
