...
namespace ac_math
{
  ...
  )
  {
    ...
    static const ac_fixed<n_frac_bits, 0, false> m_lut[n_segments_lut] = {.2451171875, .2197265625, .1796875, 0.138671875};
    static const ac_fixed<n_frac_bits, 0, false> c_lut[n_segments_lut] = {.0009765625, .24609375, .4658203125, .646484375};
...
#endif
    static const ac_fixed<11, 1, false> pi_by_2 = 1.5703125; // Store the approximate value of pi by 2
