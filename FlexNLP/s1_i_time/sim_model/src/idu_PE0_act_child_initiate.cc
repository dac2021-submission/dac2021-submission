#include <flex.h>
bool flex::decode_PE0_ACT_CHILD_PE0_act_child_initiate() {
sc_biguint<1> local_var_1 = 1;
bool local_var_2 = (flex_pe0_act_mngr_is_valid == local_var_1);
sc_biguint<1> local_var_4 = 0;
bool local_var_5 = (PE0_ACT_CHILD_pe0_act_is_start_reg == local_var_4);
bool local_var_6 = (local_var_2 & local_var_5);
sc_biguint<1> local_var_8 = 1;
bool local_var_9 = (flex_pe0_act_start_signal == local_var_8);
bool local_var_10 = (local_var_6 & local_var_9);
sc_biguint<3> local_var_12 = 4;
bool local_var_13 = (PE0_ACT_CHILD_pe0_act_state == local_var_12);
bool local_var_14 = (local_var_10 & local_var_13);
auto& univ_var_152 = local_var_14;
return univ_var_152;
}
void flex::update_PE0_ACT_CHILD_PE0_act_child_initiate() {
...
PE0_ACT_CHILD_pe0_act_instruction_counter = local_var_4_nxt_holder;
PE0_ACT_CHILD_pe0_act_is_start_reg = local_var_5_nxt_holder;
PE0_ACT_CHILD_pe0_act_output_counter = local_var_6_nxt_holder;
flex_pe0_act_start_signal = local_var_7_nxt_holder;
PE0_ACT_CHILD_pe0_act_state = local_var_8_nxt_holder;
}
