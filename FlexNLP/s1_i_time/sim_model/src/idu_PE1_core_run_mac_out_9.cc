#include <flex.h>
bool flex::decode_PE1_CORE_RUN_MAC_CHILD_PE1_core_run_mac_out_9() {
...
auto& univ_var_54 = local_var_13;
return univ_var_54;
}
void flex::update_PE1_CORE_RUN_MAC_CHILD_PE1_core_run_mac_out_9() {
auto local_var_2 = AccumAdd2(PE1_CORE_CHILD_PE1_core_accum_vector_9, PE1_CORE_RUN_MAC_CHILD_pe1_core_run_mac_child_result_temp);
...
PE1_CORE_CHILD_PE1_core_accum_vector_9 = local_var_2_nxt_holder;
