...
flex_pe2_rnn_layer_sizing_is_bias = local_var_1_nxt_holder;
flex_pe2_rnn_layer_sizing_is_cluster = local_var_3_nxt_holder;
flex_pe2_rnn_layer_sizing_is_valid = local_var_5_nxt_holder;
flex_pe2_rnn_layer_sizing_is_zero_first = local_var_7_nxt_holder;
flex_pe2_rnn_layer_sizing_num_manager = local_var_9_nxt_holder;
flex_pe2_rnn_layer_sizing_num_output = flex_data_in_5_nxt_holder;
}
