#include <flex.h>
bool flex::decode_PE2_ACT_CHILD_PE2_act_child_send_done() {
sc_biguint<3> local_var_1 = 3;
bool local_var_2 = (PE2_ACT_CHILD_pe2_act_state == local_var_1);
sc_biguint<3> local_var_4 = 2;
bool local_var_5 = (flex_pe_act_done_cntr == local_var_4);
bool local_var_6 = (local_var_2 & local_var_5);
sc_biguint<1> local_var_8 = 0;
bool local_var_9 = (PE2_ACT_CHILD_pe2_act_is_start_reg == local_var_8);
bool local_var_10 = (local_var_6 & local_var_9);
auto& univ_var_339 = local_var_10;
return univ_var_339;
}
void flex::update_PE2_ACT_CHILD_PE2_act_child_send_done() {
...
PE2_ACT_CHILD_pe2_act_state = local_var_0_nxt_holder;
