#include <flex.h>
bool flex::decode_PE1_CORE_RUN_MAC_CHILD_PE1_core_run_mac_out_12() {
...
auto& univ_var_57 = local_var_13;
return univ_var_57;
}
void flex::update_PE1_CORE_RUN_MAC_CHILD_PE1_core_run_mac_out_12() {
auto local_var_2 = AccumAdd2(PE1_CORE_CHILD_PE1_core_accum_vector_12, PE1_CORE_RUN_MAC_CHILD_pe1_core_run_mac_child_result_temp);
...
PE1_CORE_CHILD_PE1_core_accum_vector_12 = local_var_2_nxt_holder;
