#include <flex.h>
bool flex::decode_PE2_CORE_RUN_MAC_CHILD_PE2_core_run_mac_out_1() {
...
auto& univ_var_84 = local_var_13;
return univ_var_84;
}
void flex::update_PE2_CORE_RUN_MAC_CHILD_PE2_core_run_mac_out_1() {
auto local_var_2 = AccumAdd2(PE2_CORE_CHILD_PE2_core_accum_vector_1, PE2_CORE_RUN_MAC_CHILD_pe2_core_run_mac_child_result_temp);
...
PE2_CORE_CHILD_PE2_core_accum_vector_1 = local_var_2_nxt_holder;
