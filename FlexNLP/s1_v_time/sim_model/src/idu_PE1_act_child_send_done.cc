#include <flex.h>
bool flex::decode_PE1_ACT_CHILD_PE1_act_child_send_done() {
sc_biguint<3> local_var_1 = 3;
bool local_var_2 = (PE1_ACT_CHILD_pe1_act_state == local_var_1);
sc_biguint<3> local_var_4 = 1;
bool local_var_5 = (flex_pe_act_done_cntr == local_var_4);
bool local_var_6 = (local_var_2 & local_var_5);
sc_biguint<1> local_var_8 = 0;
bool local_var_9 = (PE1_ACT_CHILD_pe1_act_is_start_reg == local_var_8);
bool local_var_10 = (local_var_6 & local_var_9);
auto& univ_var_249 = local_var_10;
return univ_var_249;
}
void flex::update_PE1_ACT_CHILD_PE1_act_child_send_done() {
...
PE1_ACT_CHILD_pe1_act_state = local_var_0_nxt_holder;
