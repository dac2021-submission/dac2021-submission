...
namespace ac_math
{
  ...
  )
  {
    ...
    static const ac_fixed<n_frac_bits, 0, true> m_lut[n_segments_lut] = {-.080810546875, -.068115234375, -.05859375, -.05126953125, -.045166015625, -.040283203125, -.0361328125, -.03271484375};
    static const ac_fixed<n_frac_bits + 1, 1, false> c_lut[n_segments_lut] = {1.413330078125, 1.33251953125, 1.26416015625, 1.20556640625, 1.154296875, 1.109130859375, 1.06884765625, 1.032470703125};
